    ...
    return (
        ...
        <>
            ...
            {!loading?
                <Outlet />
                :
                <div className="flex h-screen items-center justify-center bg-opacity-50">
                    <div className="flex items-center justify-center space-x-2 text-blue-800">
                        <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-blue-100 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
